...
.to("#sommer-2020", {duration: 0.5, scale: 0.8, autoAlpha: 1, ease: "Sine.In"}, 'offers+=0.6')
.to("#vodafone-text", {duration: 0.5, scale: 0, autoAlpha: 0, ease: "Sine.In"}, 'offers+=1.3')
.to("#sommer-2020", {duration: 0.5, scale: 0, autoAlpha: 0, ease: "Sine.In"}, 'offers+=1.4')
.to("#text-logo-tm", {duration: 0.3, scale: 0.5, autoAlpha: 1, ease: "Sine.In"}, 'offers+=1.4')
;
...
.to("#sim", {duration: 0.3, scale: 1, autoAlpha: 1, ease: "Sine.in"}, 'offers+=2')
.to("#mit-ohne-vertrag", {duration: 1, autoAlpha: 1, ease: "Bounce.In"}, 'offers+=2')
...
.to("#sim", {duration: 0.1, right: 100, autoAlpha: 0, ease: "Sine.Out"}, 'offers+=3.9')
.to("#five-g-text", {duration: 0.2, left: 0, autoAlpha: 1, ease: "Sine.In"}, 'offers+=4.1')
.to("#huawei", {duration: 0.3, scale: 1, autoAlpha: 1, ease: "Sine.in"}, 'offers+=4.1')
...
.to("#huawei", {duration: 0.1, right: 100, autoAlpha: 0, ease: "Sine.Out"}, 'offers+=6.3')
;
