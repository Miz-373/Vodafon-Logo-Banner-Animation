...
tl3
.add('sale-in')
.to("#ny", {duration: 1, scale: 1.3, autoAlpha: 1, ease: "Sine.In"}, 'sale-in')
.to("#ny", {duration: 0.3, scale: 1, autoAlpha: 1, ease: "Bounce.Out"}, 'sale-in+=0.3')
.to("#nysale", {duration: 0.5, scale: 1, autoAlpha: 1, ease: "Sine.In"}, 'sale-in+=0.6')
.to("#nysale", {duration: 0.5, scale: 0.5, autoAlpha: 1, ease: "Bounce.Out"}, 'sale-in+=0.9')
.to("#ny", {duration: 0.3, scale: 0, autoAlpha: 0, ease: "Sine.In"}, 'sale-in+=1.3')
.to("#nysale", {duration: 0.5, scale: 0, autoAlpha: 0, ease: "Sine.In"}, 'sale-in+=1.4')
.to("#logo", {duration: 0.3, scale: 1, autoAlpha: 1, ease: "Sine.In"}, 'sale-in+=1.4')
;

var tl4 = gsap.timeline({onComplete:replayAnimation});
...
.to("#pd2", {duration: 0.3, left: 0, autoAlpha: 1, ease: "Sine.Out"}, 'sale-in3.3')
.to("#from", {duration: 0.2, left: 20, autoAlpha: 1, ease: "Sine.Out"}, 'sale-in3.4')
.to("#pp2", {duration: 0.6, left: 40, autoAlpha: 1, ease: "Sine.Out"}, 'sale-in3.4')
;
